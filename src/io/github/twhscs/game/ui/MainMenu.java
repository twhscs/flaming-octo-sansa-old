...
public class MainMenu implements Drawable {
  ...
  public MainMenu(Vector2i dimen, RenderWindow w) {
    ...
    for (int i = 0; i < buttonNames.length; i++) {
       ...
       */
      curButton.setPosition(dimen.x / 2 - buttonSize.x / 2, dimen.y / 2 + (buttonSize.y + 20)
          * (i - 2));
      /**
      ...
      /**
       * Set the outline thickness of the button to: - 2f if it is not selected - 4f if it is
       * selected
       */
       ...
       */
      name.setPosition(
          curButton.getPosition().x + curButton.getLocalBounds().width / 2
              - name.getLocalBounds().width / 2, curButton.getPosition().y + 7);
      /**
